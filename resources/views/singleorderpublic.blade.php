                                    ...
                                    <table class="table">
                                        ...
                                        @foreach(\App\Orders::distinct()->where('orderId',$orderNumber)->get(['productid','sender','orderId','type']) as $order)
                                            ...
                                            <tr>
                                                ...
                                                @if($order->type == "woo")
                                                    <td>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{$woo->price}}</td>
                                                    <td>{{ (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())}}</td>
                                                    <td>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{$woo->price * (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())}}</td>
                                                @else
                                                    <td>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{\App\Products::where('id',$order->productid)->value('price')}}</td>
                                                    <td>{{ (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())}}</td>
                                                    <td>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{(\App\Products::where('id',$order->productid)->value('price')) * (\App\Orders::where('productid',$order->productid)->where('orderId',$orderNumber)->count())}}</td>
                                                @endif
                                            </tr>
                                        @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$totalItem}}</td>
                                            <td><b>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{$subTotal}}</b></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>Tax</td>
                                            <td><b>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{$tax = \App\Http\Controllers\Data::getTax(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}</b></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td>Shipping Cost</td>
                                            <td> <b>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{\App\Http\Controllers\Data::getShippingCost(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}</b></td>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td>Total Cost : </td>
                                            <td> <b>{{\App\Http\Controllers\Data::getUnit(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId')))}}{{\App\Http\Controllers\Data::getShippingCost(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId'))) + \App\Http\Controllers\Data::getTax(\App\Http\Controllers\Data::getUnit(\App\Orders::where('orderId',$orderNumber)->value('pageId'))) + $subTotal}}</b></td>
                                        </tr>
