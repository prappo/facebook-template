...
Route::get('/schedule/ca','ScheduleController@runAllCamp');
...
Route::post('/update/theme', 'Settings@changeTheme');
...
Route::get('settings/pages/', 'Settings@pages');
Route::get('/settings/software','Settings@softwareSettings');
Route::post('/settings/software','Settings@updateSettings');
Route::post('/delete/page', 'Settings@deletePage');
Route::get('settings/pages/{pageId}', "Settings@pageDetail");

Route::post('settings/pages/', "Settings@updateFbPage");
Route::post('/scraper', 'ScraperController@scraper');
...
Route::get('/connect','Settings@connect');
